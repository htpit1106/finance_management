...
class AppDateUtils {
  ...
  static Future<DateTime> pickerDateShow(BuildContext context, DateTime initialDate) async {
  ...
  static Future<TimeOfDay> pickerTimeShow(BuildContext context, TimeOfDay initialDate) async {
  ...
  static String dateToStringISO8601(DateTime date, TimeOfDay time) {
    final day = DateTime(date.year, date.month, date.day, time.hour, time.minute);
